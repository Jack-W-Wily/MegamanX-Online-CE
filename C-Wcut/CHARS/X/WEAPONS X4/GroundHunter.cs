...
public class GroundHunter : Weapon {
	...
	public GroundHunter() : base() {
		...
		fireRate = 30;
		weaponSlotIndex = (int)SlotIndex.GHunter;
		...
		effect = "Press DOWN to change direction. \nC: Press UP or DOWN to spawn \nmore projectiles.";
	}
...
public class GroundHunterChargedProj : Projectile {
	...
	public GroundHunterChargedProj(
		...
		weapon, pos, xDir, 300, 4,
		player, "ground_hunter_charged_proj", 4, 0.1f,
		netProjId, player.ownedByLocalPlayer
	) {

...
public class NeonTiger : Maverick {
	...
	public override Projectile getProjFromHitbox(Collider hitbox, Point centerPoint) {
		if (sprite.name == "neont_slash") {
			...
			return new GenericMeleeProj(weapon, centerPoint, ProjIds.NeonTClawAir, player, damage: 2, flinch: Global.defFlinch, hitCooldown: 0.25f, owningActor: this);
			...
			return new GenericMeleeProj(weapon, centerPoint, ProjIds.NeonTClawWall, player, damage: 2, flinch: 0, hitCooldown: 0.25f, owningActor: this);
		}
		return null;
	}
}

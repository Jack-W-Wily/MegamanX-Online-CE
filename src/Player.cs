...
public partial class Player {
	...
	public bool isKR { get { return charNum == (int)CharIds.Kurumitos; } }

	public bool isHighMax { get { return charNum == (int)CharIds.HighMax; } }
	...
	public List<ShaderWrapper> omegaAuraShaderPurple;
	...
	public void intitalizeShaders() {
		...
		omegaAuraShaderPurple = new() { Helpers.cloneShaderSafe("omegaPurple") };
	}
	...
	public ShaderWrapper darkHoldDScreenShader = Helpers.cloneShaderSafe("sougenmuTrail");
	...
	public bool[] headArmorsPurchased = new bool[] { false, false, false ,false ,false ,false ,false, false ,false ,false};
	public bool[] bodyArmorsPurchased = new bool[] { false, false, false ,false ,false ,false ,false, false ,false ,false};
	public bool[] armArmorsPurchased = new bool[] { false, false, false ,false ,false ,false ,false, false ,false ,false};
	public bool[] bootsArmorsPurchased = new bool[] { false, false, false ,false ,false ,false ,false, false ,false ,false};
...
// XKai Armor Stuff
	...
	public Character startAtransNet(Character? oldChar, RPCAxlDisguiseJson data) {
		...
		} else if (data.charNum == (int)CharIds.ZeroEND) {
			retChar = new ZeroEND(
					this, oldChar.pos.x, oldChar.pos.y, oldChar.xDir,
				true, data.dnaNetId, false, isWarpIn: false,
				loadout: atLoadout.zeroLoadout.clone()
	...
	public Character ATVAVAMK1(Character? oldChar, RPCAxlDisguiseJson data) {
		if (oldChar == null) {
			throw new Exception("Error, A-Trans activated on null character.");
		}
		disguise = new Disguise(data.targetName);
	...
	public Character ATDragoon(Character? oldChar, RPCAxlDisguiseJson data) {
		if (oldChar == null) {
			throw new Exception("Error, A-Trans activated on null character.");
		}
		disguise = new Disguise(data.targetName);
	...
	public Character? startAtrans(Character? oldChar, DNACore dnaCore, ushort dnaNetId) {
		...
		if (spawnCharNum == (int)CharIds.X) {
			...
			retChar = new Axl(
				...
				Global.level.gameMode.setHUDErrorMessage(
					this, "Error: Non-valid char ID: " + charNum,
		...
		|| charNum == (int)CharIds.Zain
		|| charNum == (int)CharIds.Iris
		|| charNum == (int)CharIds.Dynamo
		|| charNum == (int)CharIds.Dragoon
		|| charNum == (int)CharIds.HighMax
		|| charNum == (int)CharIds.GBD
		) {
			retChar.weapons.Add(new SigmaMenuWeapon());
		}

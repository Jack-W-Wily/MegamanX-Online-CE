...
public class SigmaSlashWeaponW : Weapon {
	public SigmaSlashWeaponW() : base() {
		index = (int)WeaponIds.SigmaSlash;
		killFeedIndex = 9;
	}
}

public class SigmaSlashStateW : CharState {
	CharState prevCharState;
	int attackFrame = 2;
	bool fired;
	public SigmaSlashStateW(CharState prevCharState) : base(prevCharState.attackSprite, "", "", "") {
...
public class SigmaSlashProjW : Projectile {
	public SigmaSlashProjW(
...
public class SigmaBallProjW : Projectile {
	public SigmaBallProjW(
...
public class SigmaBallShootW : CharState {
	...
	public override void onEnter(CharState oldState) {
		...
		sigma = character as CmdSigmaW;
		character.vel = new Point();
	}
}

public class SigmaWallDashStateW : CharState {
	bool fired;
	int yDir;
	Point vel;
	bool fromGround;
	...
	public override void update() {
		...
		if (player.input.isPressed(Control.Shoot, player) &&
			...
			if (yDir == 0) {
				character.changeState(new SigmaSlashStateW(new Dash(Control.Dash)), true);
				return;
			}

...
public class SelectVileWeaponMenu : IMainMenu {
	...
	{
			Tuple.Create("Body", new List<Weapon>() { new VileCannon(VileCannonType.None), new VileCannon(VileCannonType.FrontRunner), new VileCannon(VileCannonType.LongshotGizmo), new VileCannon(VileCannonType.FatBoy) }),
			...
			Tuple.Create("", new List<Weapon>() { new VileMissile(VileMissileType.None), new VileMissile(VileMissileType.ElectricShock), new VileMissile(VileMissileType.HumerusCrush), new VileMissile(VileMissileType.PopcornDemon) }),
			Tuple.Create("", new List<Weapon>() { new RocketPunch(RocketPunchType.None), new RocketPunch(RocketPunchType.GoGetterRight), new RocketPunch(RocketPunchType.SpoiledBrat), new RocketPunch(RocketPunchType.InfinityGig) }),
			Tuple.Create("", new List<Weapon>() { new Napalm(NapalmType.NoneBall), new Napalm(NapalmType.RumblingBang), new Napalm(NapalmType.FireGrenade), new Napalm(NapalmType.SplashHit), new Napalm(NapalmType.NoneFlamethrower) }),
			Tuple.Create("", new List<Weapon>() { new VileBall(VileBallType.NoneNapalm), new VileBall(VileBallType.ExplosiveRound), new VileBall(VileBallType.SpreadShot), new VileBall(VileBallType.PeaceOutRoller), new VileBall(VileBallType.NoneFlamethrower) }),
			Tuple.Create("", new List<Weapon>() { new VileCutter(VileCutterType.None), new VileCutter(VileCutterType.QuickHomesick), new VileCutter(VileCutterType.ParasiteSword), new VileCutter(VileCutterType.MaroonedTomahawk) }),
			Tuple.Create("", new List<Weapon>() { new VileFlamethrower(VileFlamethrowerType.NoneNapalm), new VileFlamethrower(VileFlamethrowerType.WildHorseKick), new VileFlamethrower(VileFlamethrowerType.DragonsWrath), new VileFlamethrower(VileFlamethrowerType.SeaDragonRage), new VileFlamethrower(VileFlamethrowerType.NoneBall) }),
